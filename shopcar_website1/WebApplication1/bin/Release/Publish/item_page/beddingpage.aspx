...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="beddingpage.aspx.cs" Inherits="WebApplication1.beddingpage" %>
    ...
    <script type="text/javascript">
        ...
        function initial() { 
            ...
            if (targetCookie != null) {
                //alert(targetCookie);
                document.getElementById("login").innerHTML = '<a href="http://localhost:52068/membership/login.aspx" style="text-decoration:none;"><font color=#7786fb>' + targetCookie + '</font></a>';
                document.getElementById("register").style.display = "none";
                document.getElementById("logout").style.display = "inline-block";
            } else {
                document.getElementById("login").innerHTML = '<a href="http://localhost:52068/membership/login.aspx" style="text-decoration:none;"><font color=#7786fb>' +"登入"+ '</font></a>';
        ...
        function CheckIsLogIn(tag) {
            ...
            if (targetCookie != null) {
                 location.href = "http://localhost:52068/membership/shopping_car.aspx";
            } else {
                alert("請先登入會員");
                return false;
            }
    ...
    <form  id="form1" runat="server">
        ...
        <div id="itemclass_bar" class="clearfix" style="background:#d8d3d3;height:40px;min-width:1200px;text-align:center;">
            <div style="display:inline-block;padding-top:10px;">
              <div style="display:inline-block;width:220px;text-align:center;"><a href="http://localhost:52068/item_page/beddingpage.aspx" style="text-decoration: none; font-weight: bold; color: #756e6e;">寢具</a></div>             
              <div style="display:inline-block;width:220px;text-align:center;"><a href="http://localhost:52068/item_page/FurniturePage.aspx" style="text-decoration: none; font-weight: bold; color: #756e6e;">傢俱收納</a></div>             
              <div style="display:inline-block;width:220px;text-align:center;"><a href="http://localhost:52068/item_page/tablewarepage.aspx" style="text-decoration: none; font-weight: bold; color: #756e6e;">鍋具餐廚</a></div>             
              <div style="display:inline-block;width:220px;text-align:center;"><a href="http://localhost:52068/item_page/dailynecessity.aspx" style="text-decoration: none; font-weight: bold; color: #756e6e;">生活用品</a></div>      
              <div style="display:inline-block;width:220px;text-align:center;"><a href="http://localhost:52068/item_page/travelitempage.aspx" style="text-decoration: none; font-weight: bold; color: #756e6e;">休閒樂活</a></div>             
            </div>
