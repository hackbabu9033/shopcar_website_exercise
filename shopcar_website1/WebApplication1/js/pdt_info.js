function item_info(item_name, item_price, item_number, item_imgUrl) {
    ...
    this.create_div_img = function () {
        ...
        div.style.cssText = "width:360px;text-align:center;margin-top: 30px;";
        img.src = item_imgUrl;
        img.alt = "圖片顯示錯誤";
        img.width = "300";
        img.height = "250";
    ...
    this.create_div_iteminfo = function () {
        ...
        div_pdtinfo.style.cssText = "width: 300px;height:100%; margin-left: 30px;margin-top: 10px; border-top: 1px solid #d8d3d3;position:relative; ";
        div_pdtinfo.innerHTML = "<h3 class='item_pdtname'>" + this.item_name + "</h3><h4>NT <font class='item_pdtprice'>$" + this.item_price+"</font></h4>"
            + "<input type='button' id='" + this.item_number + '_test' +"' value='加入購物車' style='margin-left:63%;margin-bottom:25px; height: 24px; width: 91px;' onclick='Addtoshoppningcar(this);' /> ";
    ...
    this.create_div_infoWindow = function () {
        ...
        div_triangle.style.cssText = "width: 0;height: 0;border-style: solid;border-width: 0 5px 10px 5px;border-color: transparent transparent #808080"+
    ...
    this.create_div_Msg = function () {
        ...
        div_infoMsg.style.cssText = "margin-top:5px;";
        font_Msg.style.cssText = "font-size:15px;";
        font_Msg.innerHTML = "已經加入至您的購物車";
        div_shopcar_href.style.cssText = "margin-top:5px;";
        a_hrefShopcar.style.cssText = "text-decoration:none;position:relative;margin:3px 0px;font-size:15px";
        a_hrefShopcar.href = "../membership/shopping_car.aspx";
...
function item_objs(All_item_obj) {
    ...
    this.create_div_items = function () {
        ...
        div.style.cssText = "display:inline-block;margin-left:20%;";
