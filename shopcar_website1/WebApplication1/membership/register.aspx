         ...
         <div id="nav_bar" style="background: #343030; margin: 0; height: 70px; position: relative; min-width: 1200px; width: 100%;">
            <div id="nav_container" style="float: left; width: 70%; margin-bottom: 0px;">
                ...
                <ul style="float: left; margin-left: 30px; position: relative; margin-top: 30px;">
                    ...
                    <li style="float: left; margin-left: 30px; list-style-type: none;"><a href="../membership/shopping_car.aspx">購物車</a></li>
                </ul>
            </div>
            <div id="login_section" style="display: inline-block;">
                <ul style="position: relative; left: 100px; margin-top: 30px;">
                    <li style="display: inline-block; list-style-type: none;"><a href="../membership/login.aspx"><font color="#7786fb">登入</font></a></li>
                    <li style="display: inline-block; margin-left: 30px; list-style-type: none;"><a href="../membership/register.aspx"><font color="#7786fb">註冊</font></a></li>
