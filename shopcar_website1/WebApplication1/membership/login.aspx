         ...
         <div id="nav_bar" style="background: #343030; margin: 0; height: 70px; position: relative; min-width: 1200px; width: 100%;">
            ...
            <div id="login_section" style="display: inline-block;">
                <ul style="position: relative; left: 100px; margin-top: 30px;">
                    <li style="display: inline-block; list-style-type: none; text-decoration:none;" ><a  href="../membership/login.aspx" style="text-decoration:none;"><font color="#7786fb">登入</font></a></li>
                    <li style="display: inline-block; margin-left: 30px; list-style-type: none; text-decoration:none;"><a href="../membership/register.aspx" style="text-decoration:none;"><font color="#7786fb">註冊</font></a></li>
                </ul>
            </div>
        </div>
